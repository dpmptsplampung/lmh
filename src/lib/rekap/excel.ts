...
const COLUMNS: Array<{ header: string; key: keyof RekapTicketRow | string; width: number }> = [
  ...
  { header: 'Nama Pemohon', key: 'oss_nama_pemohon', width: 24 },
  { header: 'Nama Usaha', key: 'oss_nama_usaha', width: 24 },
  { header: 'Tipe Pelaku', key: 'oss_tipe', width: 16 },
  { header: 'Status PM', key: 'oss_status_pm', width: 14 },
  { header: 'Lokasi', key: 'oss_lokasi', width: 24 },
  { header: 'Skala', key: 'oss_skala', width: 12 },
  { header: 'KBLI', key: 'oss_kbli', width: 12 },
  { header: 'Tindak Lanjut', key: 'oss_tindak', width: 18 },
  { header: 'Uraian Solusi', key: 'oss_uraian', width: 36 },
  { header: 'Catatan', key: 'oss_catatan', width: 24 },
  { header: 'Nama Pemohon', key: 'per_nama_pemohon', width: 24 },
  { header: 'Nama Perusahaan', key: 'per_nama_perusahaan', width: 24 },
  { header: 'OPD Teknis', key: 'per_opd', width: 20 },
  { header: 'Uraian', key: 'per_uraian', width: 36 },
  { header: 'Tindak Lanjut', key: 'per_tindak', width: 18 },
  { header: 'Catatan', key: 'per_catatan', width: 24 },
];
