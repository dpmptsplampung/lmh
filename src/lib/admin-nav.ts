...
export interface AdminNavEntry {
  ...
  iconKey:
    ...
    | 'petugas' | 'jadwal' | 'settings' | 'landing' | 'public';
  roles: AdminRole[];
}

export const ADMIN_NAV: AdminNavEntry[] = [
  { label: 'Dashboard', href: '/admin', iconKey: 'dashboard', roles: ['admin'] },
  { label: 'Kunjungan', href: '/admin/kunjungan', iconKey: 'kunjungan', roles: ['admin'] },
  { label: 'Scan QR', href: '/admin/scan', iconKey: 'scan', roles: ['admin'] },
  { label: 'Antrian', href: '/admin/antrian', iconKey: 'antrian', roles: ['admin', 'petugas'] },
  { label: 'Absensi', href: '/admin/absensi', iconKey: 'absensi', roles: ['admin', 'petugas'] },
  { label: 'Live Chat', href: '/admin/chat', iconKey: 'chat', roles: ['admin', 'petugas'] },
  ...
  { label: 'Hasil SKM', href: '/admin/skm', iconKey: 'skm', roles: ['admin', 'petugas'] },
  ...
  { label: 'Jadwal Layanan', href: '/admin/settings/jadwal', iconKey: 'jadwal', roles: ['admin', 'petugas'] },
  ...
  { label: 'Tampilan Publik', href: '/', iconKey: 'public', roles: ['admin', 'petugas'] },
];
